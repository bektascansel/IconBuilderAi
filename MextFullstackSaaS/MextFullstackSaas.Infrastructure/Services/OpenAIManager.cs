...
public class OpenAIManager : IOpenAIService
{
    ...
    public async Task<List<string>> DallECreateIconAsync(DallECreateIconRequestDto requestDto, CancellationToken cancellationToken)
    {
        ...
        // TODO: Add error handling / If the model is Dall-e-3, Image size must be at least 512
    ...
    private string CreateIconPrompt(DallECreateIconRequestDto request)
    {
        ...
        promptBuilder.Append(
            $"You're a World-class Icon Designer AI, Please generate an icon for a mobile app. Make sure the icon is fitting the full width and height. Generate icon with the following specifications below. I'll tip you 1000$ for your work, if I like it. ");
